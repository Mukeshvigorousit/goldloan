    ...
    <div class="col-md-12">
        <select <?php echo  isset($_GET['order_id']) ? "disabled" : ""  ?> onChange="formVisible()" name="user_id" id='client_id' class="select2_demo_1 form-control select">
            ...
            <?php foreach ($client_list as $key => $user) { ?>
                <option <?php if (isset($order_table_data['client_id']) and $order_table_data['client_id'] == $user['id']) echo 'selected=selected ';  ?> value="<?= $user['id'] ?>"> <?= $user['name'] ?> (<?= $user['mobile'] ?>)</option>
            <?php  }  ?>
        </select>
        ...
        <div class="col-lg-12">
            <div class="ibox-content">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <select <?php if (isset($_GET['order_id'])) echo "disabled"; ?> name="main_item_id" id='main_item_id' class=" form-control select mt-4">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-10">
                        <textarea class="form-control" name="main_remark"><?= $order_table_data['remark'] ?></textarea>
                    </div>
                                        ...
                                        <tbody id="append_list">
                                            ...
                                            ?>
                                                ...
                                                <tr id="row_1" class="form-group">
                                                    ...
                                                    <!-- <td><button onclick="delete_row(1)" value="Delete" class="btn btn-sm btn-danger">Delete</button></td>  -->
                                                    <td><input type="button" onclick="delete_row(1)" value="Delete" class="btn btn-sm btn-danger" value="Delete">
                                                        <input type="hidden" name="order_item_list_id[]" id="order_item_list_id_1" value="0">
                                                    </td>
