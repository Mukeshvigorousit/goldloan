...
$_POST['jewellery_purchased_from_hindi'] = translateText($_POST['jewellery_purchased_from']);
$_POST['owner_of_jewellery_hindi'] = translateText($_POST['owner_of_jewellery']);
...
if ($_POST['order_id'] == '') {
    ...
    $_POST['net_weight_gram_gold'] = (float)$_POST['net_weight_gram_gold'];
    ...
    $_POST['net_weight_gram_silver'] = (float)$_POST['net_weight_gram_silver'];
    ...
    //  this code for add item 
    // foreach ($item_id as $key => $item) {
    //     if ($item_id[$key] != 0) {
    //         $grade = item_name($item);
    //         $insertArray = [
    //             "order_id" => $order_id,
    //             "item_id" => $item,
    //             "client_id" => $client_id,
    ...
    $insert_transaction = insert_array("amount_tbl", $insert_amount);
