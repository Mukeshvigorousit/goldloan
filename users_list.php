...
{   
    ...
    $where="user_type='".$usertype."' AND store_id='".$_SESSION['user_data']['store_id']."' AND status='1'";
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $data['address']?$data['address']:"Not Inserted" ?></td>
                                <?php if($show_is_employee){?>
                                <td><?= $data['username']?></td>
                                <td><?= $data['password']?></td>
                                <?php }  ?>
                                ...
                                <td>
                                        <a href="javascript:void(0);" style="color:white;" class="btn btn-danger btn-sm" onclick="delete_client(<?= $data['id'] ?>)">Delete</a>
                                    </td>
                            </tr>
                            <?php } ?>
    ...
    function delete_client(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const res = sendAjax("ajax/delete_client", sendData);
