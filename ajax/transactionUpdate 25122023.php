...
if (isset($loan_close_narration)) {


	$order_update = [
		'loan_finish_date' => _date(),
		'loan_close_narration' => $loan_close_narration,
		'is_finish' => 1,
	];

	$udate = update_array('order_tbl', $order_update, "order_id='" . $order_id . "'");

	$insertArray = [
		"order_id" => $order_id,
		"narration_type" => 'Loan Closing',
		"narration_text" => $loan_close_narration,
	...
	if ($discount != 0) {
		$discount = $order_data['discount'] + $discount;
	}
