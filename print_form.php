    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        ...
        <div class="col-lg-4">
            <div class="title-action">
                ...
                <a href="gernrate_pdf?order_id=<?= $order_data['order_id'] ?>&action=download_form" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> Download
                    Form </a>
                <!-- target="_blank" -->
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="ibox-content p-xl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm col-md-3">
                            <h3>Owner Of Jewellery:
                                <br>आभूषण का मालिक :
                            </h3>
                        </div>
                        <div class="col-sm col-md-3 mt-3">
                            <b><?= strtoupper($order_data['owner_of_jewellery']) ?> <br>
                                <?= strtoupper($order_data['owner_of_jewellery_hindi']) ?></b>
                        </div>
                        <div class="col-sm col-md-3">
                            <h3>Jewellery Purchased From:
                                <br>आभूषण कहाँ से खरीदा :
                            </h3>
                        </div>
                        <div class="col-sm col-md-3 mt-3">
                            <b><?= strtoupper($order_data['jewellery_purchased_from']) ?> <br>
                                <?= strtoupper($order_data['jewellery_purchased_from_hindi']) ?> </b>
                        </div>

                    </div>


<?php  if($order_data['total_weight_gram_gold']>0)
                    {
                        ?>
                    <div class="row">
                        <div class="col-sm col-md-3">
                            <h3>Net Weight Of Gold:
                                <br>सोने का शुद्ध वजन:
                            </h3>
                        </div>
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $gold_net_weight['weight_kg'] != '0' ? strtoupper($gold_net_weight['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $gold_net_weight['weight_gram'] != '0' ? strtoupper($gold_net_weight['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $gold_net_weight['weight_mlgm'] != '0' ? " + ".strtoupper($gold_net_weight['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
  ...
  <div class="row">
                        ...
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $total_weight_gram_gold['weight_kg'] != '0' ? strtoupper($total_weight_gram_gold['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $total_weight_gram_gold['weight_gram'] != '0' ? strtoupper($total_weight_gram_gold['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $total_weight_gram_gold['weight_mlgm'] != '0' ? " + ".strtoupper($total_weight_gram_gold['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
  ...
  <div class="row">
                        ...
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $gold_approx_weight['weight_kg'] != '0' ? strtoupper($gold_approx_weight['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $gold_approx_weight['weight_gram'] != '0' ? strtoupper($gold_approx_weight['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $gold_approx_weight['weight_mlgm'] != '0' ? " + ".strtoupper($gold_approx_weight['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
...
<?php  if($order_data['total_weight_gram_silver']>0)
                    {
                        ?>
                    <div class="row">
                        <div class="col-sm col-md-3">
                            <h3>Net Weight Of Silver :
                                <br> चाँदी का शुद्ध वजन:
                            </h3>
                        </div>
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $total_weight_gram_silver['weight_kg'] != '0' ? strtoupper($total_weight_gram_silver['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $total_weight_gram_silver['weight_gram'] != '0' ? strtoupper($total_weight_gram_silver['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $total_weight_gram_silver['weight_mlgm'] != '0' ? " + ".strtoupper($total_weight_gram_silver['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
  ...
  <div class="row">
                        ...
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $net_weight_gram_silver['weight_kg'] != '0' ? strtoupper($net_weight_gram_silver['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $net_weight_gram_silver['weight_gram'] != '0' ? strtoupper($net_weight_gram_silver['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $net_weight_gram_silver['weight_mlgm'] != '0' ? " + ".strtoupper($net_weight_gram_silver['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
  ...
  <div class="row">
                        ...
                        <div class="col-sm col-md-6 mt-3">
                            <b>
                                ...
                                // _dx($gold_net_weight );
                                ?>
                                <?php echo $silver_approx_weight['weight_kg'] != '0' ? strtoupper($silver_approx_weight['weight_kg']) . '<small> ( Kg/किलोग्राम) </small>+' : '' ?>
                                <?php echo $silver_approx_weight['weight_gram'] != '0' ? strtoupper($silver_approx_weight['weight_gram']) . '<small> (Gm/ग्राम) </small>' : '' ?>
                                <?php echo $silver_approx_weight['weight_mlgm'] != '0' ? " + ".strtoupper($silver_approx_weight['weight_mlgm']) . '<small> (MlGm/मिलीग्राम) </small>' : '' ?>
                                <!-- <?= strtoupper($order_data['weight_gm_gold']) ?><small> ( Gm/ग्राम) </small> +
                                <?= strtoupper($order_data['weight_mlgm_gold']) ?> <small> (MlGm/मिलीग्राम)</small> -->
                            </b>
                        </div>
